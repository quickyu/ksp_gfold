...
class GFoldSolver:
    ...
    def _setup_problem(self):
        ...
        target_pos = cp.Parameter(3, name="target_position", value=config.spacecraft.target_position)
        ...
        for i in range(n):
            ...
            constraints.append(u[i, 2] >= max_angle*s[i])
        ...
        obj = cp.Minimize(cp.norm(x[n-1, :3]))
    ...
    def solve(self, verbose=False):
        ...
        solution_val = self.problem.solve(solver=cp.ECOS, verbose=verbose)
